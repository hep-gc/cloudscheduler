...
def add(request):
    ...
    if rc != 0:
        config.db_close()
        #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s %s' % (lno(MODID), msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
    ...
    if request.method == 'POST':
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group add %s' % (lno(MODID), msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        ...
        if 'vm_flavor' in fields and fields['vm_flavor']:
            ...
            if rc != 0:
                config.db_close()
                #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group add, "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
    ...
    ### Bad request.
        ...
        #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group add, invalid method "%s" specified.' % (lno(MODID), request.method), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        return list(request, active_user=active_user, response_code=1, message='%s group add, invalid method "%s" specified.' % (lno(MODID), request.method))
...
def delete(request):
    ...
    if request.method == 'POST':
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group delete %s' % (lno(MODID), msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        ...
        for row in group_list:
            if row['group_name'] == fields['group_name'] and row['metadata_names']:
                ...
                for metadata_name in metadata_names:
                    ...
                    if rc != 0:
                        config.db_close()
                        #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group metadata file delete "%s::%s" failed - %s.' % (lno(MODID), fields['group_name'], metadata_name, msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
                        return list(request, active_user=active_user, response_code=1, message='%s group metadata file delete "%s::%s" failed - %s.' % (lno(MODID), fields['group_name'], metadata_name, msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group resources delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group resource metadata delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group resource metadata delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s delete group metadata exclusions for group "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s delete group metadata exclusions for group "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group users delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group VMs defaults delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group VMs defaults delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group keynames delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group keynames delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group networks delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group networks delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group  security groups delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group  security groups delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group limits delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group limits delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group images delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group images delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc != 0:
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group flavors delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group flavors delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))
        ...
        if rc == 0:
            ...
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group delete "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg))

    ### Bad request.
    else:
        #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group delete, invalid method "%s" specified.' % (lno(MODID), request.method), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
...
def update(request):
    ...
    if request.method == 'POST':
        ...
        if rc != 0:
            config.db_close()
            #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group update %s' % (lno(MODID), msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
            return list(request, active_user=active_user, response_code=1, message='%s group update %s' % (lno(MODID), msg))

        if 'vm_flavor' in fields and fields['vm_flavor']:
            rc, msg = validate_by_filtered_table_entries(config, fields['vm_flavor'], 'vm_flavor', 'cloud_flavors', 'name', [['group_name', fields['group_name']]])
            if rc != 0:
                config.db_close()
                #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group update, "%s" failed - %s.' % (lno(MODID), fields['group_name'], msg), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        ...
        if len(group_updates) > 0:
            ...
            if 'username' not in fields:
                config.db_close()
                #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group update must specify at least one field to update.' % lno(MODID), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
    ...
    ### Bad request.
        ...
        #return render(request, 'csv2/groups.html', {'response_code': 1, 'message': '%s group update, invalid method "%s" specified.' % (lno(MODID), request.method), 'active_user': active_user.username, 'active_group': active_user.active_group, 'user_groups': active_user.user_groups})
        return list(request, active_user=active_user, response_code=1, message='%s group update, invalid method "%s" specified.' % (lno(MODID), request.method))
