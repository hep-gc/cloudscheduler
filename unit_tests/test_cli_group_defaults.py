...
def main(gvar):
    ...
    table_headers = {
        # 23 - 29
        'Active Group Defaults': ['Group', 'HTCondor', 'FQDN', 'Container Hostname', 'Other Submitters', 'VM', 'Flavor', 'Image', 'Keep Alive', 'Keyname', 'Network', 'Security Groups', 'Job', 'Cores', 'Disk (GBs)', 'RAM (MBs)', 'Swap (GBs)'],
        # 30 - 39
