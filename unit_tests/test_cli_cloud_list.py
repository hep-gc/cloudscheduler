...
def main(gvar, user_secret):
    ...
    execute_csv2_command(
        ...
        ['cloudscheduler', 'cloud', 'list', '-g', ut_id(gvar, 'clg1'), '-xx', 'yy']
    )
    ...
    execute_csv2_command(
        ...
        ['cloudscheduler', 'cloud', 'list', '-s', 'invalid-unit-test'], timeout=8
    )
    ...
    execute_csv2_command(
        ...
        ['cloudscheduler', 'cloud', 'list', '-h', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret]
    )
    ...
    execute_csv2_command(
        ...
        ['cloudscheduler', 'cloud', 'list', '-xA', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret]
    )
    ...
    execute_csv2_command(
        ...
        ['cloudscheduler', 'cloud', 'list', '-s', 'unit-test', '-g', ut_id(gvar, 'clg1'), '-su', ut_id(gvar, 'clu4'), '-spw', user_secret]
    )
    ...
    execute_csv2_command(
        gvar, 0, None, 'Rows: 0',
        ['cloudscheduler', 'cloud', 'list', '-cn', 'invalid-unit-test', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret]
    )

    # 13
    execute_csv2_command(
        gvar, 0, None, 'Rows: 1',
        ['cloudscheduler', 'cloud', 'list', '-cn', ut_id(gvar, 'clc2'), '-su', ut_id(gvar, 'clu4'), '-spw', user_secret]
    )

    # 14
    execute_csv2_command(
        gvar, 0, None, None,
        ['cloudscheduler', 'cloud', 'list', '-ok', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret],
    ...
    execute_csv2_command(
        ...
        ['cloudscheduler', 'cloud', 'list', '-VC', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret]
    )

    # 16
    execute_csv2_command(
        gvar, 0, None, None,
        ['cloudscheduler', 'cloud', 'list', '-NV', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret],
    ...
    execute_csv2_command(
        gvar, 0, None, None,
        ['cloudscheduler', 'cloud', 'list', '-V', 'enabled,authurl', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret],
    ...
    execute_csv2_command(
        gvar, 0, None, None,
        ['cloudscheduler', 'cloud', 'list', '-r', '-su', ut_id(gvar, 'clu4'), '-spw', user_secret],
