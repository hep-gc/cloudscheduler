...
def main(gvar, user_secret):
    ...
    execute_csv2_request(
        ...
        '/group/metadata-fetch/?"{}"'.format(ut_id(gvar,'gtg5')),
    ...
    execute_csv2_request(
        ...
        '/group/metadata-fetch/?invalid-unit-test', query_data={'metadata_name': 'invalid-unit-test'},
    ...
    execute_csv2_request(
        gvar, 0, None, None,
        '/group/metadata-fetch/?"{}"'.format(ut_id(gvar,'gtg5')), query_data={'metadata_name': ut_id(gvar, 'gty5')},
        server_user=ut_id(gvar, 'gtu3'), server_pw=user_secret
    )
