...
def main(gvar, user_secret):
    ...
    execute_csv2_request(
        ...
        values={'group_name': ut_id(gvar, 'gtg1'), 'metadata_names': None, 'htcondor_fqdn': 'group-unit-test-one.ca'}
    )
    ...
    execute_csv2_request(
        ...
        values={'group_name': ut_id(gvar, 'gtg2'), 'metadata_names': None, 'htcondor_fqdn': 'unit-test-group-two.ca'}
    )
