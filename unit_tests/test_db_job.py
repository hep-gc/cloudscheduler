...
def main(gvar, user_secret):
    ...
    execute_csv2_request(
        ...
        values={'hold_job_reason': None, 'request_ram': 2000, 'js_idle': 0, 'held_reason': 'vm-testing', 'instance_type': 'vm-test-instance', 'request_disk': '14.3051', 'js_held': 1, 'request_cpus': 1, 'keep_alive': '0', 'js_completed': 0, 'js_running': 0, 'js_other': 0, 'job_status': 5, 'user': ut_id(gvar, 'dtu1'), 'requirements': 'group_name is "{}"'.format(ut_id(gvar, 'dtg1')), 'cloud_name': None, 'proc_id': 0, 'target_clouds': None, 'job_priority': 10, 'cluster_id': 1}
    )
