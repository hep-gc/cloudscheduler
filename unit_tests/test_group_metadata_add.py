...
, form_data={
    ...
    execute_csv2_request(
        gvar, 0, None, None,
        '/group/list/', list='group_list', filter={'group_name': ut_id(gvar, 'gtg4')},
    ...
    execute_csv2_request(
        gvar, 0, None, None,
        '/group/metadata-list/', group=ut_id(gvar, 'gtg5'), list='group_metadata_list', filter={'metadata_name': ut_id(gvar, 'gty1.yaml')},
