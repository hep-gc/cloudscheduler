...
def main(gvar):
    ...
    parameters = {
        ...
        # 19
        'cloud_type': {'valid': 'openstack', 'test_cases': {'invalid-unit-test': 'cloud add value specified for "cloud_type" must be one of the following options: [\'amazon\', \'local\', \'openstack\', \'oracle\'].'}, 'mandatory': True},
        # 20 Omit authurl.
