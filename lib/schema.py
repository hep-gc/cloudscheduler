...
view_available_resources_test = Table('view_available_resources_test', metadata,
...
view_cloud_status_test = Table('view_cloud_status_test', metadata,
...
view_groups_of_idle_jobs_test = Table('view_groups_of_idle_jobs_test', metadata,
...
view_t2 = Table('view_t2', metadata,

view_t3 = Table('view_t3', metadata,
