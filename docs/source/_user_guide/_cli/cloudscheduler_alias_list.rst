...
..   1. edit the man page file(s) ".../cloudscheduler/cli/man/csv2_alias_list.1"
..   2. run the utility ".../cloudscheduler/utilities/cli_doc_to_rst"
..

man(1) page: cloudscheduler alias list
======================================
...
**NAME**
       **cloudscheduler alias lst**
       - list aliases for the current CSV2 group:
 
**SYNOPSIS**
       **cloudscheduler alias list mandatory_parameters**
       [*options*
       ...]
 
**DESCRIPTION**
       Lists  all  the  alias  definitions together with member clouds for the
       current group.  All users within a group may list and use aliases.
...
**EXAMPLES**
       1.     List all defined aliases for the current group:
              ...
              + Group   | Alias      | Clouds                  +
              +=========+============+=========================+
              | testing | amazon     | amazon-east,amazon-west |
              | testing | colin      | amazon-west             |
              | testing | kevin-test | cloud7,cloud9,sig-test  |
              | testing | new        | test                    |
              +---------+------------+-------------------------+
