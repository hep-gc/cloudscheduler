...
def status_poller():
    ...
    services = ["csv2-main", "csv2-openstack", "csv2-jobs", "csv2-machines", "csv2-status", "csv2-timeseries", "csv2-ec2", "csv2-htc-agent", "csv2-watch", "csv2-startd-errors", "rabbitmq-server", "mariadb", "condor"]
    db_service_names = {
                        "csv2-main":        "csv2_main", 
